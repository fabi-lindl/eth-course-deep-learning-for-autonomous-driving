...
from mtl.models.model_parts import Encoder, get_encoder_channel_counts, ASPP, DecoderDeeplabV3p, DecoderDeeplabV3pSA, SelfAttention, DecoderDeeplabSA
...
class ModelDeepLabV3PlusBranchedSA(torch.nn.Module):
    ...
    def __init__(self, cfg, outputs_desc):
        ...
        self.decoder_2_segm = DecoderDeeplabSA(256+ch_out_encoder_4x, ch_out_segm)
        ...
        self.decoder_2_depth = DecoderDeeplabSA(256+ch_out_encoder_4x, ch_out_depth)
    ...
    def forward(self, x):
        ...
        # Segmentation head.
        predictions_4x_segm_2 = self.decoder_2_segm(features_4x_segm, sa_features_depth)
        predictions_1x_segm_2 = F.interpolate(predictions_4x_segm_2, size=input_resolution, mode='bilinear', align_corners=False)
        # Depth estimation head.
        predictions_4x_depth_2 = self.decoder_2_depth(features_4x_depth, sa_features_segm)
